...
class MonkeeUtil {
	constructor() {
		this.DEBUG = false;
		if(this.DEBUG) {
			$global.console.info("[Monkee-Z]" + " " + "MonkeeUtil" + " - build: " + "2021-05-22 10:01:18");
		}
		this.init();
	}
	init() {
	...
	static mdTable2HTMLTable(id,filename) {
		$global.console.info("[Monkee-Z]" + " " + "MonkeeUtil :: embedSpecs" + " - build: " + "2021-05-22 10:01:18");
	...
	static embedCode(id,filename) {
		$global.console.info("[Monkee-Z]" + " " + "MonkeeUtil :: embedCode" + " - build: " + "2021-05-22 10:01:18");
