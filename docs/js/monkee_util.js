...
class MonkeeUtil {
	constructor() {
		$global.console.info("[Monkee-Z]" + " - " + "MonkeeUtil" + " - build: " + "2021-05-17 10:09:45");
		this.init();
	}
	init() {
	...
	static mdTable2HTMLTable(id,filename) {
		$global.console.info("[Monkee-Z]" + " - " + "MonkeeUtil :: embedSpecs" + " - build: " + "2021-05-17 10:09:45");
	...
	static embedCode(id,filename) {
		$global.console.info("[Monkee-Z]" + " - " + "MonkeeUtil :: embedCode" + " - build: " + "2021-05-17 10:09:45");
