...
class MonkeeGuiTest {
	constructor() {
		this.cellDepth = 189.0;
		this.cellHeight = 189.0;
		this.cellWidth = 189.0;
		this.description = "";
		this.patternName = "";
		this.title = "";
		let gui = MonkeeGui.create(0,0,window.document.getElementById("monkee-gui"));
		gui.range("size_in_mm",20,100,this.cellWidth,1,$bind(this,this.onChangeSizeHandler));
		gui.number("size_in_mm",20,100,this.cellWidth,1,$bind(this,this.onChangeSizeHandler));
		gui.button("Export 2 SVG",$bind(this,this.export2svg));
		gui.button("Export 2 PNG",$bind(this,this.export2png));
		gui.button("Export 2 JPG",$bind(this,this.export2jpg));
		...
		gui.textArea("Description",this.description,$bind(this,this.onChangeSizeHandler)).disabled();
	...
	draw() {
		$global.console.log("DRAW (" + this.description + ")");
	}
	export2svg() {
		$global.console.log("SVG");
	}
	export2png() {
		$global.console.log("PNG");
	}
	export2jpg() {
		$global.console.log("JPEG");
	}
	static main() {
